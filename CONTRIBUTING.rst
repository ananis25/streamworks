...
Welcome to ``streamworks`` contributor's guide.
...
If you experience bugs or general issues with ``streamworks``, please have a look
...
You can help improve ``streamworks`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``streamworks`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``streamworks``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/streamworks.git
    cd streamworks
...
#. Install |pre-commit|_::
   ...
   ``streamworks`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/streamworks
.. _issue tracker: https://github.com/<USERNAME>/streamworks/issues
.. <-- end -->
